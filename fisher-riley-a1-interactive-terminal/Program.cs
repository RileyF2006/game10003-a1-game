...
if (option1 == "left")
{
    ...
    string caveDoor = Console.ReadLine().ToLower();
    ...
    if (caveDoor == "yes")
    {
        ...
        if (mathAnswer == 28)
        {
            ...
            string cavePath = Console.ReadLine().ToLower();
...
else if (option1 == "right")
{
    ...
    string villageChoice = Console.ReadLine().ToLower();
    ...
    if (villageChoice == "talk")
    {
        ...
        string villager = Console.ReadLine().ToLower();
